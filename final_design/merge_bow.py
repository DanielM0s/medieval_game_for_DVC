...
bow = bow_calculator.Bow("long Bow", 710, 0.762)
arrow = bow_calculator.Arrow(0.1)
enemy = fighting.Enemy("enemy",2.5, random.randint(300, 400))
...
q = input("press 1 to fight the enemy, press two to shoot them down: ")
if q == "1":
