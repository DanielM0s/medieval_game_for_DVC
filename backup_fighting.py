...
class character:
    def __init__(self, stats_dict):
        ...
        self.charisma = stats_dict["charisma"]
        self.health = stats_dict["health"]
...
class Enemy:
    ...
    def attack(self, force):
        damage = force * enemy_inventory["Ilkwa"]["length"]
        self.strength -= force
        return damage
    ...
    while True:
        ...
        while True:
            try:
                ...
                enemy_name = enemy_names[target]
                enemy = enemies[enemy_name]
                enemy = list(enemies.values())[target]
                ...
                if enemy["health"] > 0:
                    ...
                    cha["health"] -= enemy_attack
                    print(f"{enemy['name']} hits you for {enemy_attack} damage, you have {cha['health']} health left")
            except ValueError:
                print("Invalid input")
                continue
